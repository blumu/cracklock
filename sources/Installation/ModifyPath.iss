...
// 07/09/2007: Bug fixed by William Blum: path modification failed when the PATH regkey was inexistant.
...
begin
  ...
  /////// Code modified by William Blum
  if RegValueExists(RegRootKey, RegSubKeyName, RegValueName) then
    begin
