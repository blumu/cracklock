...
#
{
    ...
    # Lance la compilation de tous les modules de Cracklock
	print "   * Compilation du fichier project Visual Studio\n";
	#launch(qq#"start compile.cmd" clean#, TRUE);

	print "   * Compilation des traducations\n";
	launch(qq#"$MULTILIZER"  build Traductions\\cracklock.mpr#, TRUE);

	# génération des fichiers .chm
	print "   * Compilation des fichier d'aide (.chm)\n";
	gen_chm() or goto err;
